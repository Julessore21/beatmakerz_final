...
const Footer: React.FC = () => {
  return (
    <footer className="w-full mt-16 sm:mt-20 text-white/90 border-t border-white/10 bg-transparent">
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8 pt-12 pb-14">
        {/* Top brand row */}
