        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2 ml-6">
            ...
            <button
              ...
              className="p-1 rounded-full border border-white/20 text-white focus:outline-none"
            >
        ...
        <AnimatePresence>
          {isOpen && (
            ...
            >
              ...
              <div
                ref={overlayRef}
                className="absolute top-0 left-0 h-screen w-2/5 bg-black bg-opacity-50 backdrop-blur-md text-white transform transition-transform duration-300 flex flex-col pt-16 space-y-8"
              >
